...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Thu Nov 27 02:29:35 2025
#
...
class Ventana4(wx.Frame):
    def __init__(self, parent, informacion="", subtotal=0, informacion2="", subtotal2=0):
        ...
        self.lbTaquilla = wx.StaticText(self.panel_1, wx.ID_ANY, "---", style=wx.ALIGN_CENTER_HORIZONTAL)
        self.lbTaquilla.SetMinSize((100, 100))
        self.lbTaquilla.SetBackgroundColour(wx.Colour(255, 233, 238))
        sizer_1.Add(self.lbTaquilla, 0, wx.EXPAND, 0)

        self.lbSubtotalTaquilla = wx.StaticText(self.panel_1, wx.ID_ANY, "Subtotal: $")
        ...
        self.lbDulceria = wx.StaticText(self.panel_1, wx.ID_ANY, "---", style=wx.ALIGN_CENTER_HORIZONTAL)
        self.lbDulceria.SetMinSize((100, 100))
        self.lbDulceria.SetBackgroundColour(wx.Colour(255, 233, 238))
        sizer_1.Add(self.lbDulceria, 0, wx.EXPAND, 0)
        ...
        self.lbTotal = wx.StaticText(self.panel_1, wx.ID_ANY, "Total: $", style=wx.ALIGN_RIGHT)
        self.lbTotal.SetForegroundColour(wx.Colour(194, 0, 0))
        self.lbTotal.SetFont(wx.Font(24, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        sizer_1.Add(self.lbTotal, 0, wx.EXPAND, 0)
...
class Ventana2(wx.Frame):
    ...
    def seleccionPelicula(self, event):  # wxGlade: Ventana2.<event_handler>
        ...
        self.rbHorario1.SetLabel(horario)
